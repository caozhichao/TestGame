...
package org.robotlegs.mvcs
{
	...
	public class Context extends ContextBase implements IContext
	{
		...
		{
			return _reflector ||= new SwiftSuspendersReflector() as IReflector;
		}
		...
		{
			return _commandMap ||= new CommandMap(eventDispatcher, createChildInjector(), reflector) as ICommandMap;
		}
		...
		{
			return _mediatorMap ||= new MediatorMap(contextView, createChildInjector(), reflector) as IMediatorMap;
		}
		...
		{
			return _viewMap ||= new ViewMap(contextView, injector) as IViewMap;
		}
