package
{
	...
	public class TestServerSocket extends Sprite
	{
		...
		{
			log("connection close" + clientSocket.remoteAddress + ":" + clientSocket.remotePort);
		}
		...
		{
			clientSocket.close();
			log("server exe clientSocket.close()");
		}
		...
		private function setupUI():void
		{
			...
			createTextButton( 230, 60, "Close", close );
